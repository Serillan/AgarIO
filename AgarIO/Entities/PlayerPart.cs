...
namespace AgarIO.Entities
{
    ...
    class PlayerPart : Entity
    {
        ...
        public float Speed
        {
            ...
            {
                if (IsBeingEjected)
                    return (OldRadius * 12 / DefaultDivisionTime) * Game.GameLoopInterval / 30f;
                return (DivisionTime > 0 ? (this.Radius * 8 / DefaultDivisionTime) : 20 / NthRoot(Mass, 5)) * Game.GameLoopInterval / 30f;
            }
        }
